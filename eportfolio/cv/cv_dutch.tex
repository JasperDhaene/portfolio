...
%%% Essentials
\name{Jasper}{D'haene}
\address{Sint-Rembertlaan 15, 8820 Torhout, West-Vlaanderen, Belgium}
\mobile{(+32) 477/42 70 92} 
\user{°11/02/1994} 
%%% Social
\email{jasper.dhaene@gmail.com}
%%%\homepage{users.hogent.be/jasperdhaene}
\github{JasperDhaene}
\linkedin{jasperdhaene}
%%% Optionals
\position{Student{\enskip\cdotp\enskip}Toegepaste Informatica}
\quote{http://users.hogent.be/jasperdhaene/eportfolio}
...
\makecvfooter
  {\today}
  {Jasper D'haene~~~·~~~Curriculum Vitae}
  {\thepage}
...
%%% Import contents
\import{\sectiondir}{education_dutch.tex}
\import{\sectiondir}{skills_dutch.tex}
